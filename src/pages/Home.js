      ...
      <div className="video_box">
        ...
        <div className="wrap">
          <div className="bottom_banner">
            <div className="txt">
              <img src="/img/main-banner-icn1.png" alt="아이콘" />
              <p>상담문의</p>
            </div>
            <div className="form">
      ...
      <div className="main_sec1" ref={contentRef}>
        <div className="wrap">
          ...
          <div className="bottom">
            <div>
              <img src="/img/main-con1-icn3.png" alt="아이콘" />
              <div className="txt">
                <b>HRDe LMS</b>
                <p>
                  사업주직업훈련도 손쉽게! <br />
            ...
            <div>
              <img src="/img/main-con1-icn4.png" alt="아이콘" />
              <div className="txt">
                <b>HRDe 아카이브</b>
                <p>
                  보고 싶은 콘텐츠, 직접 선택! <br />
            ...
            <div>
              <img src="/img/main-con1-icn5.png" alt="아이콘" />
              <div className="txt">
                <b>자체콘텐츠 탑재</b>
                <p>
                  교육 기획 걱정 끝! <br />
            ...
            <div>
              <img src="/img/main-con1-icn6.png" alt="아이콘" />
              <div className="txt">
                <b>콘텐츠 구독</b>
                <p>
                  콘텐츠 구독으로 무제한! <br />
        ...
        <div className="wrap">
          ...
          <ul>
            <li>
              ...
              <img src="/img/main-con2-icn1.png" alt="아이콘" />
            </li>
            <li>
              <p>최신 디자인의 홈페이지 제공</p>
              <img src="/img/main-con2-icn2.png" alt="아이콘" />
            </li>
            <li>
              <p>고품질의 자제콘텐츠 제작 및 임대</p>
              <img src="/img/main-con2-icn3.png" alt="아이콘" />
            </li>
            <li>
              <p>쌍방향 아카이브 플랫폼등 다양한 플랫폼 연동</p>
              <img src="/img/main-con2-icn4.png" alt="아이콘" />
            </li>
            <li>
              <p>신속한 응대 고객센터 운영</p>
              <img src="/img/main-con2-icn5.png" alt="아이콘" />
            </li>
          </ul>
        </div>
      </div>
